...
[Download](#installation) • [Features](#features) • [Usage](#usage) • [Build](#building-from-source) • [中文说明](#中文说明)
...
### Menu Bar Interface
The app lives quietly in your menu bar with a custom icon and comprehensive settings.
...
**20-20-20护眼助手**是一款轻量级的macOS菜单栏应用，帮助您自动遵循20-20-20护眼法则：每20分钟，看向20英尺（6米）外的物体至少20秒，有效减少眼疲劳。
...
#### 方式1：下载发布版（推荐）
1. 从 [Releases](https://github.com/javenfang/20-20-20-Mac-App/releases) 下载最新的 `20-20-20.app`
2. 将应用移至应用程序文件夹
3. 运行应用，开始健康的屏幕使用时间！

#### 方式2：从源代码构建
参见上方的 [Building from Source](#building-from-source) 部分。
